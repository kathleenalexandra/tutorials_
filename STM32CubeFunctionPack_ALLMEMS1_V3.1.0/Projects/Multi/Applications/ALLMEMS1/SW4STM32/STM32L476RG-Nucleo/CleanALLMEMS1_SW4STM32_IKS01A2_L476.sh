...
echo "/******************************************/"
${OpenOCD_CMD} -c "init" -c "halt" -c "flash erase_sector 0 510 511" -c "shutdown"
echo "/******************************************/"
...
echo "/******************************************/"
${OpenOCD_CMD} -c "init" -c "flash write_image erase  ./STM32L4xx-Nucleo/Debug_IKS01A2/ALLMEMS1_IKS01A2_NucleoL476.bin 0x08004000 bin" -c "shutdown"
echo "/******************************************/"
